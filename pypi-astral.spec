...
Source0  : https://files.pythonhosted.org/packages/73/1f/b903786c3ac972d891d8dec600622ce80e3113b39fbcadb77ce8394853bc/astral-3.1.tar.gz
...
%prep
%setup -q -n astral-3.1
cd %{_builddir}/astral-3.1
pushd ..
cp -a astral-3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667330366
